    ...
    <>
      <nav className="nav">
        <div className="nav__content flex place-content-between">
            ...
            <div className="flex flex-col md:flex-row lg:mx-6">
              ...
              {userInfo ? (
                <div className="relative inline-block">
                  ...
                  <div
                    className={`absolute right-0 z-20 w-64 py-2 mt-2 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-800 ${
                  ...
                  >
                    ...
                    <div
                      ...
                      className={`${style.itemdrop} cursor-pointer`}
                    >
                      Cerrar Sesión
                    </div>
                  </div>
          ...
          <div className="nav__content-items block md:hidden">
            <button
              type="button"
              aria-disabled={open}
              disabled={open}
      ...
      <Sidenav open={open} toggle={toggle}>
        {links.map((link, index) => (
          <NavLink to={link.url} key={index} className={style.item}>
            {link.svg}
...
const style = {
  ...
  itemdrop: `block px-4 py-3 text-sm text-gray-600 transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white`,
